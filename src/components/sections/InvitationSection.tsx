...
const InvitationSection = ({ bgColor = 'white' }: InvitationSectionProps) => {
    ...
    const groomParentsText = getParentsText(invitation.groom.father || '', invitation.groom.mother || '', hasGroomFather, hasGroomMother);

    const brideParentsText = getParentsText(invitation.bride.father || '', invitation.bride.mother || '', hasBrideFather, hasBrideMother);
